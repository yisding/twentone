...
function runComparison() {
  ...
  const noDasTestCases: TestCase[] = [
    ...
    { playerCards: [card("5"), card("4")], dealerUpCard: card("6"), expected: "hit", category: "No DAS - split hand 9 vs 6 cannot double", playerOverrides: { isSplit: true } },
  ];
  ...
  const noSurrenderTestCases: TestCase[] = [
    ...
    { playerCards: [card("10"), card("6")], dealerUpCard: card("10"), expected: "hit", category: "No Surr - split hand cannot surrender", playerOverrides: { isSplit: true } },
  ];
